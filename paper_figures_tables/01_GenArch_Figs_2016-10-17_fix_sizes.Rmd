...
gplot(all,aes(x=R2,y=pve50)) + geom_point() +coord_cartesian(xlim=c(-0.05,1.05),ylim=c(-0.05,1.05)) + theme_bw() +xlab(expression("elastic net R"^2))+ylab('BSLMM PVE')+geom_abline(intercept=0,slope=1)
