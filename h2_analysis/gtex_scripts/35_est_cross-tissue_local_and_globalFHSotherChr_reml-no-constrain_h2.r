...
for(i in 1:length(localensid)){
  ...
  ## Y ~ localGRM
  runLOC <- "gcta64 --grm " %&% grm.dir %&% ensid %&% " --reml-no-constrain --pheno tmp.pheno." %&% thresh %&% gencodeset %&% " --out tmp." %&% thresh %&% gencodeset
  system(runLOC)
  ...
  runGLO <- "gcta64 --grm " %&% grm.trans.dir %&% "global-" %&% ensid %&% "-otherChr --reml-no-constrain --pheno tmp.pheno." %&% thresh %&% gencodeset %&% " --out tmp." %&% thresh %&% gencodeset
  system(runGLO)
  if(file.exists("tmp." %&% thresh %&% gencodeset %&% ".hsq")==TRUE){
    hsq <- scan("tmp." %&% thresh %&% gencodeset %&% ".hsq","character")
